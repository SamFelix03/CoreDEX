...
export const FORWARD_MARKET_ABI = [
  ...
  { name: "matchOrder",      type: "function", stateMutability: "payable",    inputs: [{ name: "orderId", type: "uint256" }], outputs: [] },
...
export const OPTIONS_ENGINE_ABI = [
  ...
  { name: "writePut",    type: "function", stateMutability: "payable",    inputs: [{ name: "regionId", type: "uint256" }, { name: "strikePriceDOT", type: "uint256" }, { name: "expiryBlock", type: "uint256" }], outputs: [{ name: "optionId", type: "uint256" }] },
  { name: "buyOption",   type: "function", stateMutability: "payable",    inputs: [{ name: "optionId", type: "uint256" }], outputs: [] },
  { name: "exercise",    type: "function", stateMutability: "payable",    inputs: [{ name: "optionId", type: "uint256" }], outputs: [] },
...
export const YIELD_VAULT_ABI = [
  ...
  { name: "borrow",     type: "function", stateMutability: "payable",    inputs: [{ name: "coreCount", type: "uint256" }, { name: "durationBlocks", type: "uint256" }], outputs: [{ name: "loanId", type: "uint256" }] },
