...
// ─── Chain ────────────────────────────────────────────────────────────────────
export const ASSET_HUB_CHAIN_ID   = Number(process.env.NEXT_PUBLIC_CHAIN_ID ?? "420420421");
export const ASSET_HUB_RPC        = process.env.NEXT_PUBLIC_ASSET_HUB_RPC ?? "https://westend-asset-hub-eth-rpc.polkadot.io";
...
export const CORETIME_LEDGER_ADDRESS = (process.env.NEXT_PUBLIC_CORETIME_LEDGER_ADDRESS ?? "0x0000000000000000000000000000000000000000") as `0x${string}`;
export const FORWARD_MARKET_ADDRESS  = (process.env.NEXT_PUBLIC_FORWARD_MARKET_ADDRESS  ?? "0x0000000000000000000000000000000000000000") as `0x${string}`;
export const OPTIONS_ENGINE_ADDRESS  = (process.env.NEXT_PUBLIC_OPTIONS_ENGINE_ADDRESS  ?? "0x0000000000000000000000000000000000000000") as `0x${string}`;
...
export const SETTLEMENT_ADDRESS      = (process.env.NEXT_PUBLIC_SETTLEMENT_ADDRESS      ?? "0x0000000000000000000000000000000000000000") as `0x${string}`;
